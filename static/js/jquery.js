! function(e, t) {
    ...
    w.fn = w.prototype = {
        ...
        for ("boolean" == typeof o && (u = o, o = arguments[s] || {}, s++), "object" == typeof o || w.isFunction(o) || (o = {}), s === a && (o = this, s--); s < a; s++)
            if (null != (e = arguments[s]))
                for (t in e) i = o[t], o !== (n = e[t]) && (u && n && (w.isPlainObject(n) || (r = w.isArray(n))) ? (i = r ? (r = !1, i && w.isArray(i) ? i : []) : i && w.isPlainObject(i) ? i : {}, o[t] = w.extend(u, i, n)) : void 0 !== n && (o[t] = n));
        return o
    }, w.extend({
    ...
    var d = function(n) {
        ...
        for (e in d = re.support = {}, t = re.isXML = function(e) {
                ...
                }), v = v.length && new RegExp(v.join("|")), i = i.length && new RegExp(i.join("|")), e = K.test(r.compareDocumentPosition), x = e || K.test(r.contains) ? function(e, t) {
        ...
        function me(d, h, g, m, y, e) {
            return m && !m[C] && (m = me(m)), y && !y[C] && (y = me(y, e)), oe(function(e, t, n, r) {
                var i, o, s, a = [],
                    ...
                    p = g ? y || (e ? d : l || m) ? [] : t : f;
                if (g && g(f, p, n, r), m)
                    for (i = ge(p, u), m(i, [], n, r), o = i.length; o--;)(s = i[o]) && (p[u[o]] = !(f[u[o]] = s));
                if (e) {
                    if (y || d) {
                        if (y) {
    ...
    (w.fn.init = function(e, t) {
        ...
        if (n[1]) {
            if (t = t instanceof w ? t[0] : t, w.merge(this, w.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : v, !0)), b.test(n[1]) && w.isPlainObject(t))
    ...
    function Ge(i, e, t) {
        ...
        for (! function(e, t) {
                var n, r, i, o, s;
                for (n in e)
                    if (i = t[r = w.camelCase(n)], o = e[n], w.isArray(o) && (i = o[1], o = e[n] = o[0]), n !== r && (e[r] = o, delete e[n]), (s = w.cssHooks[r]) && "expand" in s)
            ...
            select: {
                get: function(e) {
                    for (var t, n = e.options, r = e.selectedIndex, i = "select-one" === e.type || r < 0, o = i ? null : [], s = i ? r + 1 : n.length, a = r < 0 ? s : i ? r : 0; a < s; a++)
                        if (((t = n[a]).selected || a === r) && (y.optDisabled ? !t.disabled : null === t.getAttribute("disabled")) && (!t.parentNode.disabled || !w.nodeName(t.parentNode, "optgroup"))) {
